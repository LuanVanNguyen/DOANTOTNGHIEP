      ...
      <main class="main">
        ...
        @foreach($all as $tt)
          <div class="content">
            ...
            <form action="{{URL::to('/luutintuc'.$tt->id)}}" id ="form__add" method="post" class="form__add" enctype="multipart/form-data">
            @csrf
              ...
              <div class="form_add__name pb_3rem">
                ...
                <input class="form_add__input"  type="text" name="noidung" placeholder="Nhập nội dung tin tức" value="{{$tt->noidung}}">
              </div>
