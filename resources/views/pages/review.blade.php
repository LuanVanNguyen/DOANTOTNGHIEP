      ...
      <div class="container">
        <div class="row">
          <div class="header-main col-lg-12">
            ...
            <h1 class="header-title">ĐÁNH GIÁ</h1>
        ...
        <div class="booking-form">
          ...
          <form action="{{URL::to('/luureview')}}" method="post">
            ...
            <div class="booking-form-item required">
              ...
              <input type="text" name="sdt" class="input" placeholder="+84" />
            </div>


            <div class="booking-form-item required">
              <label>Lời Đánh giá của bạn !</label>
              <textarea name="noidung" id="" placeholder="Nhập đánh giá của bạn"></textarea>
            </div>
            <div class="booking-form-item required">
