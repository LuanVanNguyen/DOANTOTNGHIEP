    ...
    <div class="wrapper contact-page">
                ...
                <div class="container">
                    ...
                    ?>
                                    ...
                                    <li class="menu-item menu-search">
                                        ...
                                        <form action="{{URL::to('/timkiemSP')}}" method="POST" class="search-header"
            ...
            <div class="contact-wrapper">
                <div class="container">
                    <div class="row row-map">
                        <div class="col-sm-12 col-md-12 col-lg-4">
                            <div class="list-shop">
                                ...
                                <div class="nav flex-column" role="tablist" aria-orientation="vertical">
                                    ...
                                    <div class="nav-link active shop-item" data-toggle="pill" href="#shop1">
                        ...
                        <div class="tab-content col-sm-12 col-md-12 col-lg-8" id="v-pills-tabContent">
                            <div class="tab-pane iframe-cover fade show active" id="shop1" role="tabpanel">
                                <iframe
                            ...
                            <div class="tab-pane iframe-cover fade" role="tabpanel" id="shop2">
                                <iframe
                            ...
                            <div class="tab-pane iframe-cover fade" role="tabpanel" id="shop3">
                                <iframe
                ...
                <div class="row">
                    <div class="footer-col footer-col-1 col">
                        <div class="footer-col-content footer-info">
                            <a href="home-page.html" class="footer-logo"><img src="public/front//images/logo-vmms.png"
                                    alt="Logo" /></a>
                        ...
                        <div class="fanpage-facebook">
                            ...
                            <div class="fanpage-facebook-content">
                                ...
                                <div class="fanpage-facebook-like">
                                    <a href="http://www.facebook.com/"><img src="public/front//images/icon-face2.png" />
                                        Like Page</a><span>50K người đã thích</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container footer--bottom">
                <div class="row">
                    ...
                    <div class="col col-sm-12 col-md-5">
                        <a href="!#" target="_blank" class="footer-bct"><img
                                src="public/front/images/thongbaobocongthuong.png" alt="Thông báo bộ công thương" /></a>
                        <div class="social-network">
                            <div class="social-network__title">KẾT NỐI VỚI CHÚNG TÔI</div>
                            <ul class="social-network__list">
                                <li>
                                    <a href="https://www.facebook.com/" rel="nofollow" target="_blank"><img
                                            src="public/front/images/icon-face.svg" alt="facebook" /></a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/" rel="nofollow" target="_blank"><img
                                            src="public/front/images/icon-instagram.svg" alt="instagram" /></a>
                                </li>
                                <li>
                                    <a href="https://www.youtube.com/" rel="nofollow" target="_blank"><img
                                            src="public/front/images/icon-twitter.svg" alt="twitter" /></a>
                                </li>
                                <li>
                                    <a href="https://mail.google.com/" rel="nofollow" target="_blank"><img
                                            src="public/front/images/icon-gg.svg" alt="Gmail" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="mobile-sidebar d-lg-none">
            <div class="mobile-sidebar--top">
                <a href="https://www.facebook.com/" class="mobile-sidebar-logo"><img
                        src="public/front/images/logo-vmms.png" alt="Logo" /></a>
