...
<html lang="vi">
  <head>
    ...
    <link rel="stylesheet" href="public/front/css/delivery-page.css" />
  </head>
        ...
        <div class="container">
          <div class="row">
            <div class="header-main col-lg-12">
              ...
              <h1 class="header-title">DELIVERY</h1>
                ...
                <div class="delivery-list">
                  <a href="https://shopeefood.vn/" class="delivery-item">
                    <div class="delivery-item__image">
                      <img src="public/front/images/logo-now.jpg" alt="" />
                    </div>
                  ...
                  <a href="https://shopeefood.vn/" class="delivery-item">
                    <div class="delivery-item__image">
                      <img src="public/front/images/logo-shoppefood.jpg" alt="" />
                    </div>
