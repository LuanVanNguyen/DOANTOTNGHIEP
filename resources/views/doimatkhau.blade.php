...
<body>
<div class="main">
        <form action="{{URL::to('/luuthaydoi')}}" method ="POST" class="form" id="form-2">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="password" name="old_password" type="password" placeholder="Nhập mật khẩu" class="form-control">
                <span class="form-message"></span>
            </div>
