...
<body>
    <div class="main">
        <form action="{{URL::to('/luuthaydoi')}}" method="POST" class="form" id="form-1">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="hoten" class="form-control" value="<?php
            ...
            <div class="form-group">
                <label for="repassword" class="form-label">Mật khẩu mới</label>
                <input id="password" name="repassword" type="password" placeholder="Nhập mật khẩu"
                    class="form-control" />
                <span class="form-message"></span>
            </div>
            <input type="submit" name="submit" class="form-submit" value="Lưu thay đổi" />

            <div class="spacer"></div>
            <a style="font-size : 15px; text-decoration : none;" href="{{URL::to('/profile')}}">Quay lại trang cá
                nhân</a>
        </form>
